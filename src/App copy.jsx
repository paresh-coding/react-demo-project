...
import { mySchema1, mySchema2, json1, json2, json3, mySchema3, myBaseSchema, myBaseSchemaLatest, json4, mySchema5 } from './dataConfig';
    ...
    render() {
        return (
            <div>
                ...
                <div className="container text-center"><button className="btn btn-primary" onClick={() => {
                        // console.log(mainBindFunction(json2,mySchema2))
                       this.setState({
                        schema: JSON.stringify(mainBindFunction(json4,myBaseSchema))  
                       })                    
                    this.setState({
                        showForm: true
                    })
